...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Course.js"></script>
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel"  scrollable title="课程信息" @on-ok="save" >
                                   <i-form v-model="detailform" label-position="left" :label-width="100">   
                                      <Form-item label="课程名">
                                         <i-input v-model="detailform.name"  id="name" placeholder="请输入课程名" style="width:380px;border:1px solid #dddee1;">
                                          </Form-item>                     
                           </i-form>
                           <div slot="footer">
