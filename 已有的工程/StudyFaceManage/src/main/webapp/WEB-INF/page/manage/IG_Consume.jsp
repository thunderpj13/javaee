...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Consume.js"></script>
...
<body class=" theme-blue">
    ...
    <div class="content">
            ...
            <h1 class="page-title">学生消费信息</h1>
                    <ul class="breadcrumb">
            <li><a href="javascript:void(0)">主页</a> </li>
            <li class="active">学生消费信息</li>
        </ul>
      ...
      <div class="row">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel"  scrollable title="学生消费信息" @on-ok="save" >
						        ...
						        {{item.name }}</Option>
                                  ...
                                  <Form-item label="消费项目:">
		 			            <select id="modalItemId"   v-model="itemId"  style="width:100%;border:1px solid #dddee1;padding:5px;border-radius:4px;font-size:14px;" >
						        <Option v-for="item in  ItemList" :value="item.id" :key="item.id">
						        {{item.name }}</Option>
					             </select>
                                 </Form-item>  
                                 <Form-item label="消费时间:">
                                         <input  id="consumeTime" placeholder="请选择消费时间" style="width:100%;border:1px solid #dddee1;">
                                          </Form-item>  
                                    <Form-item label="消费金额">
                                   <i-input v-model="detailform.money"  id="money" placeholder="请输入消费金额" style="width:380px;border:1px solid #dddee1;">
                                    </Form-item>                 
                           </i-form>
                           <div slot="footer">
