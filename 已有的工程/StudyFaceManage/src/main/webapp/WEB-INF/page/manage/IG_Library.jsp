...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Library.js"></script>
...
<body class=" theme-blue">
    ...
    <div class="content">
            ...
            <h1 class="page-title">图书馆进出信息</h1>
                    <ul class="breadcrumb">
            <li><a href="javascript:void(0)">主页</a> </li>
            <li class="active">图书馆进出信息</li>
        </ul>
      ...
      <div class="row">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel"  scrollable title="图书馆进出记录" @on-ok="save" >
