...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Score.js"></script>
...
<body class=" theme-blue">
    ...
    <div class="content">
            ...
            <h1 class="page-title">成绩表信息</h1>
                    <ul class="breadcrumb">
            <li><a href="javascript:void(0)">主页</a> </li>
            <li class="active">成绩表信息</li>
        </ul>
      ...
      <div class="row">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel" scrollable title="成绩表信息" @on-ok="save" >
						        ...
						        {{item.name }}</Option>
                                  ...
                                  <Form-item label="分数">
                                  <i-input v-model="detailform.score"  id="score" placeholder="请输入分数" style="width:380px;border:1px solid #dddee1;">
                                  </Form-item> 
