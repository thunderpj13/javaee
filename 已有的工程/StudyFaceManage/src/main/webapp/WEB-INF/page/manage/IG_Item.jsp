...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Item.js"></script>
...
<body class=" theme-blue">
    ...
    <div class="content">
            ...
            <h1 class="page-title">消费项目信息</h1>
                    <ul class="breadcrumb">
            <li><a href="javascript:void(0)">主页</a> </li>
            <li class="active">消费项目信息</li>
        </ul>
      ...
      <div class="row">
								<div class="col-lg-4">
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button class="btn btn-default" type="button">项目名</button>
										</span> <input type="text" class="form-control" placeholder="请输入项目名"	id="name">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel"  scrollable title="消费项目信息" @on-ok="save" >
